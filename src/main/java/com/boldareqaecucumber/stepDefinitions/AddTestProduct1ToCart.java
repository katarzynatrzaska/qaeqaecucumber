...
public class AddTestProduct1ToCart extends TestBase {
    ...
    public void userClicksOnAddToCartButton() { testProduct1.clickOnAddCartButton(); }

    @Then("^Success Message is Displayed$")
    public void assertThatAddToCartMessageIsDisplayed() { assertTrue(testProduct1.isSuccessMessageDisplayed()); }

    @Then("^Item and Price is Displayed$")
    public void isItemAndPriceDisplayed() { assertTrue(testProduct1.isItemAndPriceDisplayed()); }
